export class AppShellScreenController {
  ...
  setActiveView(viewName) {
    const views = [
      ...
      { key: "variaciones", element: this.elements.variationsView, nav: this.elements.navVariationsBtn },
      { key: "planes", element: this.elements.plansView, nav: this.elements.navPlansBtn },
  ...
  setAvailableViews(viewNames = []) {
    ...
    const navigation = [
      ...
      { key: "variaciones", element: this.elements.navVariationsBtn },
      { key: "planes", element: this.elements.navPlansBtn },
    ];
